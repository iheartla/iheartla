...
class DIRSumIndexVisitor(DIRIterator):
    __instance = None

    @staticmethod
    def getInstance():
        if DIRSumIndexVisitor.__instance is None:
            DIRSumIndexVisitor()
        return DIRSumIndexVisitor.__instance

    def __init__(self):
        super().__init__()
        DIRSumIndexVisitor.__instance = self
        self.variable = ''      #  
