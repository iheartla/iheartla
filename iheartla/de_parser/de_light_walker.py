...
class DSolverParamWalker(DLightWalker):
    __instance = None

    @staticmethod
    def getInstance():
        if DSolverParamWalker.__instance is None:
            DSolverParamWalker()
        return DSolverParamWalker.__instance

    def __init__(self):
        super().__init__()
        DSolverParamWalker.__instance = self
