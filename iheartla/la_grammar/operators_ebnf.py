...
sum_operator::Summation
    ...
    | SUM '_(' {hspace} id:identifier_alone {hspace} '=' {hspace} lower:expression {hspace}')^' upper:(identifier_alone|integer) {hspace}+ exp:term
    | SUM '_(' {hspace} id:identifier_alone {hspace} '=' {hspace} lower:expression {hspace}')^(' {hspace} upper:expression {hspace}')' {hspace}+ exp:term
    | SUM '_(' {hspace} enum+:identifier_alone {{hspace} {','} {hspace} enum+:identifier_alone} {hspace} IN {hspace} range:(function_operator | builtin_operators | identifier_alone) {hspace} ')' {hspace}+ exp:term
