...
class grammarde_initBuffer(Buffer):
...
class grammarde_initParser(Parser):
...
if __name__ == '__main__':
    ...
    ast = generic_main(main, grammarde_initParser, name='grammarde_init')
    data = asjson(ast)
...
class grammarde_initModelBuilderSemantics(ModelBuilderSemantics):
