...
class grammar2245023265ae4cf87d02c8b6ba991139Buffer(Buffer):
    def __init__(
        ...
        **kwargs
        ...
        super(grammar2245023265ae4cf87d02c8b6ba991139Buffer, self).__init__(
            text,
...
class grammar2245023265ae4cf87d02c8b6ba991139Parser(Parser):
    def __init__(
        ...
        keywords=None,
        namechars='',
        buffer_class=grammar2245023265ae4cf87d02c8b6ba991139Buffer,
        **kwargs
    ):
        if keywords is None:
            keywords = KEYWORDS
        super(grammar2245023265ae4cf87d02c8b6ba991139Parser, self).__init__(
            whitespace=whitespace,
            nameguard=nameguard,
            comments_re=comments_re,
            eol_comments_re=eol_comments_re,
...
class grammar2245023265ae4cf87d02c8b6ba991139ModelBuilderSemantics(ModelBuilderSemantics):
    def __init__(self, context=None, types=None):
        ...
        super(grammar2245023265ae4cf87d02c8b6ba991139ModelBuilderSemantics, self).__init__(context=context, types=types)
