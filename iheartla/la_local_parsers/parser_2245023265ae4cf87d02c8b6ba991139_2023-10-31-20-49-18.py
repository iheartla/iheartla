...
class grammar2245023265ae4cf87d02c8b6ba991139Buffer(Buffer):
...
class grammar2245023265ae4cf87d02c8b6ba991139Parser(Parser):
    ...
    def _CONF_KEYWORDS_(self):  # noqa
        with self._choice():
            ...
            self._error(
                ...
                'ODE RK SOLVE Solve [Δ] euler explicit'
    ...
    def _identifier_(self):  # noqa
        with self._choice():
            ...
            self._error(
                ...
                'explicit implicit is mesh triangle ∇⋅'
            )
    ...
    def _multi_str_(self):  # noqa
        with self._choice():
            ...
            self._error(
                ...
                '<WITH> ODE RK [Δ] euler explicit'
                'implicit is mesh triangle ∇ ∇⋅ ∈ 𝕕'
            )
    ...
    def _map_type_(self):  # noqa
        with self._choice():
            ...
            self._error(
                ...
                '<tuple_type> <vector_type> ODE RK [ℝℤ]'
                'euler explicit implicit is matrix mesh'
                'scalar triangle vector ℝ ℤ ∇⋅'
            )
...
class grammar2245023265ae4cf87d02c8b6ba991139Semantics:
...
def main(filename, **kwargs):
    if not filename or filename == '-':
        ...
        with open(filename) as f:
            text = f.read()
    parser = grammar2245023265ae4cf87d02c8b6ba991139Parser()
    return parser.parse(
        text,
        filename=filename,
        **kwargs
...
if __name__ == '__main__':
    ...
    ast = generic_main(main, grammar2245023265ae4cf87d02c8b6ba991139Parser, name='grammar2245023265ae4cf87d02c8b6ba991139')
    data = asjson(ast)
...
class grammar2245023265ae4cf87d02c8b6ba991139ModelBuilderSemantics(ModelBuilderSemantics):
