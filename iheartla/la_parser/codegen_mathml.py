...
class CodeGenMathML(CodeGen):
    ...
    def init_type(self, type_walker, func_name):
        ...
        self.uni_convert_dict = {'ᵢ': '\\textsubscript{i}', 'ⱼ': '\\textsubscript{j}', 'ᵣ': '\\textsubscript{r}',
                                 ...
                                 '𝐳': '\\textbf{z}', '⩽': '\\leq', '⩾': '\\geq'}
        self.pre_str = r'''
<math xmlns="http://www.w3.org/1998/Math/MathML" display="block" onclick="alert('You clicked an equation');">
...
'''[1:]
    ...
    def visit_id(self, node, **kwargs):
        ...
        return r"""<mi data-mjx-variant="-tex-mathit" mathvariant="italic" onclick="event.stopPropagation(); alert('You clicked a symbol');" id='{}'>{}</mi>"""\
            .format(self.convert_unicode(node.get_name()), self.convert_unicode(node.get_name()))
